...
const StatCard = ({ label, value }: { label: string; value: number }) => (
  <div className="bg-[#2A4A42] p-4 rounded-lg shadow-md border border-[#eedfc9]/20 hover:border-[#eedfc9]/40 transition-colors">
...
export default function ProfileContent({ userId }: ProfileContentProps) {
  ...
  return (
    <div className="min-h-screen bg-[#2A4A42]">
      <div className="max-w-2xl mx-auto p-4">
        <div className="bg-[#2A4A42] rounded-lg shadow-md p-6 mb-6 border border-[#eedfc9]/20">
          <div className="flex items-center space-x-4">
            ...
            />
            <div>
              <h1 className="text-[#eedfc9] text-2xl font-bold">{userToDisplay.name}</h1>
              <p className="text-[#eedfc9]/80">{userToDisplay.email}</p>
            </div>
          </div>
