...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function loadDashboard() {
      ...
      try {
        const [profileData, groupMemberships, recommended, posts, angels] = await Promise.all([
            ...
            <div className="border-t border-[#eedfc8]/10 bg-[#eedfc8]/4 p-6 lg:border-l lg:border-t-0">
              ...
              <div className="mt-4 space-y-4">
                <div className="card-light !p-4">
                  ...
                  <p className="mt-2 text-3xl font-bold text-[#D19A58]">{formatCompactNumber(activeDays)}</p>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="card-light !p-4">
                    <p className="text-xs text-[#eedfc8]/45">Groups</p>
                    <p className="mt-2 text-2xl font-bold text-[#eedfc8]">{formatCompactNumber(memberships.length)}</p>
                  </div>
                  <div className="card-light !p-4">
                    <p className="text-xs text-[#eedfc8]/45">Support team</p>
                    <p className="mt-2 text-2xl font-bold text-[#eedfc8]">{formatCompactNumber(supportTeamCount)}</p>
                  </div>
                </div>
                <div className="card-light !p-4">
        ...
        <div className="page-grid lg:grid-cols-[minmax(0,1.35fr)_minmax(19rem,24rem)] lg:items-start">
            ...
            <section className="card">
              ...
              {loading ? (
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 line-clamp-2 text-xs text-[#eedfc8]/50">
                              {(group.description as string | undefined) || 'A space to keep showing up for each other.'}
                            </p>
                ...
                <div className="card-light text-center">
                  ...
                  <Link href="/explore" className="btn-primary mt-4 inline-flex !py-2.5 !px-4 text-xs">
                    Explore groups
                  </Link>
                </div>
              )}
              ...
              <div className="space-y-3">
                {recentPosts.length > 0 ? (
                  recentPosts.slice(0, 4).map((post) => {
                    ...
                    return (
                      <div key={post.id} className="rounded-2xl border border-[#eedfc8]/8 bg-[#eedfc8]/4 p-4">
                  ...
                  <div className="card-light text-center">
                    ...
                    <Link href="/community" className="btn-secondary mt-4 inline-flex !py-2.5 !px-4 text-xs">
                      Start a post
                    </Link>
                  </div>
                )}
          ...
          <aside className="space-y-5">
                  ...
                  recommendedGroups.map((group) => (
                    ...
                    >
                      ...
                      <p className="mt-1 text-sm text-[#eedfc8]/55">
                        {(group.description as string | undefined) || 'A live community space waiting for you.'}
                      </p>
            ...
            <section className="card">
              ...
              <div className="space-y-3">
                <Link href="/settings" className="card-light flex items-center gap-3 transition-colors hover:bg-[#eedfc8]/12">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#eedfc8]/45">Keep your preferences and support needs current.</p>
                  </div>
                </Link>
                <Link href="/resources" className="card-light flex items-center gap-3 transition-colors hover:bg-[#eedfc8]/12">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#eedfc8]/45">Read guides and support material published to the platform.</p>
                  </div>
                </Link>
              </div>
            </section>
