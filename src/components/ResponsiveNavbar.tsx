...
export default function ResponsiveNavbar() {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#243947] px-4 sm:px-10 py-3 relative z-30 bg-[#111b22]">
      ...
      <div className={`flex items-center gap-4 text-white ${open ? 'hidden' : ''} md:flex`}>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-50 bg-[#111b22] bg-opacity-95 flex flex-col items-end p-4 animate-fade-in">
          <button
            className="text-white focus:outline-none p-2 mb-2"
