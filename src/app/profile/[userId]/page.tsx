...
const SPACE_ACCENTS: Record<
  SpaceAccentKey,
  { label: string; chip: string; hex: string; soft: string; glow: string; card: string; raised: string; strong: string; line: string }
> = {
  sage: {
    label: 'Sage',
    chip: 'bg-emerald-300',
    ...
    card: 'rgba(23, 52, 43, 0.82)',
    raised: 'rgba(29, 68, 56, 0.86)',
    strong: 'rgba(39, 84, 69, 0.9)',
    line: 'rgba(167, 243, 208, 0.22)',
  },
  gold: {
    label: 'Gold',
    chip: 'bg-amber-300',
    ...
    card: 'rgba(54, 45, 28, 0.84)',
    raised: 'rgba(69, 57, 34, 0.88)',
    strong: 'rgba(84, 69, 40, 0.92)',
    line: 'rgba(252, 211, 77, 0.25)',
  },
  coral: {
    label: 'Coral',
    chip: 'bg-orange-300',
    hex: '#fdba74',
    soft: 'rgba(253, 186, 116, 0.18)',
    glow: 'rgba(253, 186, 116, 0.36)',
    card: 'rgba(62, 37, 28, 0.84)',
    raised: 'rgba(80, 46, 34, 0.88)',
  ...
  violet: {
    ...
    glow: 'rgba(196, 181, 253, 0.36)',
    card: 'rgba(41, 31, 64, 0.84)',
  ...
  sky: {
    ...
    card: 'rgba(25, 47, 63, 0.84)',
    raised: 'rgba(31, 61, 82, 0.88)',
...
export default function ProfilePage({ params }: { params: Promise<{ userId: string }> }) {
  ...
  const spaceVars = {
    ...
    '--space-card': spaceAccent.card,
    '--space-card-soft': spaceAccent.raised,
    '--space-line': spaceAccent.line,
    '--surface': spaceAccent.card,
    '--surface-raised': spaceAccent.raised,
    '--surface-strong': spaceAccent.strong,
    '--surface-sunken': spaceAccent.card,
    '--line': spaceAccent.line,
    '--line-strong': spaceAccent.line,
    '--glass-bg': spaceAccent.card,
    '--glass-border': spaceAccent.line,
    '--accent': spaceAccent.hex,
    '--accent-2': spaceAccent.hex,
    '--accent-3': spaceAccent.hex,
    '--accent-bright': spaceAccent.hex,
    '--accent-2-bright': spaceAccent.hex,
    '--accent-3-bright': spaceAccent.hex,
